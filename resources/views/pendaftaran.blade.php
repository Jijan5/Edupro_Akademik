...
<head>
    ...
    <title>Formulir Pendaftaran - EduPro</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <script src="//unpkg.com/alpinejs" defer></script>
    <style>
        /* kecilkan overlay blur agar mirip screenshot */
        .bg-pattern {
            background: linear-gradient(to right, #a9b63b, #3b66a7);
        }
                ...
                <div class="p-8 md:p-2">
                    ...
                    <form action="{{ route('pendaftaran.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="flex flex-wrap items-center gap-5 text-sm md:text-base">
                            <span class="text-gray-200">Universitas:</span>

                            <label class="inline-flex items-center gap-2">
                                <input type="radio" name="universitas" value="ARS" class="form-radio text-blue-500"
                                    required>
                                <span class="text-gray-100">ARS University</span>
                            </label>

                            <label class="inline-flex items-center gap-2">
                                <input type="radio" name="universitas" value="STIT"
                                    class="form-radio text-blue-500">
                                <span class="text-gray-100">STIT Bandung</span>
                            </label>

                            <label class="inline-flex items-center gap-2">
                                <input type="radio" name="universitas" value="IWU"
                                    class="form-radio text-blue-500">
                                <span class="text-gray-100">IWU</span>
                            </label>

                            <label class="inline-flex items-center gap-2">
                                <input type="radio" name="universitas" value="UICM"
                                    class="form-radio text-blue-500">
                                <span class="text-gray-100">UICM</span>
                            </label>

                            <label class="inline-flex items-center gap-2">
                                <input type="radio" name="universitas" value="STIEB"
                                    class="form-radio text-blue-500">
                                <span class="text-gray-100">STIEB Bina Esa</span>
                            </label>
                        </div>

                        <!-- Fakultas / Program Studi (dropdowns) -->
                        <div>
                            <div class="relative flex items-center bg-white/10 rounded-md px-3 py-2">
                                <select name="fakultas"
                                    class="w-full appearance-none bg-transparent text-gray-300 placeholder-gray-400 focus:outline-none cursor-pointer">
                                    <option value="" disabled selected>Fakultas</option>
                                    <option value="WNI" class="bg-gray-100 text-gray-700">Teknik Komputer</option>
                                    <option value="WNA" class="bg-gray-100 text-gray-700">Manajemen</option>
                                </select>
                        ...
                        <div>
                            <div class="relative flex items-center bg-white/10 rounded-md px-3 py-2">
                                <select name="program_studi"
                                    ...
                                    <option value="WNI" class="bg-gray-100 text-gray-700">Sistem Informasi</option>
                                    <option value="WNA" class="bg-gray-100 text-gray-700">Akuntansi</option>
                                </select>
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="absolute right-3 w-5 h-5 text-gray-300 pointer-events-none" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div>
                                ...
                                <div class="flex items-center bg-white/10 rounded-md px-3 py-2">
                                    <!-- icon -->
                                    <svg class="w-[20px] h-[20px] text-gray-500 dark:text-white mr-3" aria-hidden="true"
                                    ...
                                    <input name="nama_lengkap" type="text" placeholder="Nama Lengkap"
                                        class="w-full bg-transparent text-gray-100 placeholder-gray-300 focus:outline-none" />
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    <div class="flex items-center bg-white/10 rounded-md px-3 py-2">
                                        <svg class="w-[20px] h-[20px] text-gray-500 dark:text-white mr-3"
                        ...
                        <div x-data="{ jalur_program: ' ' }" class="space-y-4">
                            <div class="flex items-center gap-4 text-sm">
                                <span class="text-gray-200">Jalur Program:</span>

                                <label class="inline-flex items-center gap-2">
                                    <input type="radio" name="jalur_program" value="KIP"
                                        x-model="jalur_program" class="form-radio">
                                    <span class="text-gray-100">KIP</span>
                                </label>

                                <label class="inline-flex items-center gap-2">
                                    <input type="radio" name="jalur_program" value="Non-KIP"
                                        x-model="jalur_program" class="form-radio">
                                    <span class="text-gray-100">Non-KIP</span>
                                </label>
                            </div>
                            ...
                            <div x-show="jalur_program === 'KIP'" x-transition
                                ...
                                <div>
                                    <label for="nomor_kip" class="block text-gray-100 mb-1">Nomor KIP</label>
                       ...
                       file:text-sm file:font-semibold file:bg-blue-600 file:text-white hover:file:bg-blue-700">
                        ...
                        <div>
                            <div class="flex items-center bg-white/10 rounded-md px-3 py-2">
                                <svg class="w-5 h-5 text-gray-300 mr-3" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor">
                        ...
                        <div x-data="{
                            ...
                            <div>
                                <div class="flex items-center bg-white/10 rounded-md px-3 py-2">
                                    ...
                                    <input :type="showPassword ? 'text' : 'password'" x-model="password"
                                        ...
                                        class="w-full bg-transparent text-gray-500 placeholder-gray-300 focus:outline-none"
                                        @input="error = (confirmPassword && password !== confirmPassword) ? 'Password tidak sesuai' : ''" />
                                    <button type="button" @click="showPassword = !showPassword"
                                        class="ml-3 text-gray-700">
                                        <template x-if="!showPassword">
                                            <!-- Eye -->
                                            <svg class="w-[20px] h-[20px] text-gray-500 dark:text-white"
                            ...
                            <div>
                                <div class="flex items-center bg-white/10 rounded-md px-3 py-2">
                                    <svg class="w-5 h-5 text-gray-600 mr-3"></svg>
                                    <input :type="showConfirmPassword ? 'text' : 'password'" x-model="confirmPassword"
                                        name="Konfirm_password" placeholder="Ulangi Password"
                                        class="w-full bg-transparent text-gray-300 placeholder-gray-300 focus:outline-none"
                        ...
                        <div class="space-y-6 mt-6">
                            ...
                            <div>
                                ...
                                <div class="flex flex-col md:flex-row items-center gap-3">
                                    <!-- Soal -->
                                    <div
                                        class="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-md text-gray-200 font-semibold min-w-[100px] justify-center">
                                        <span x-text="captchaText"></span>
                                    </div>

                                    <!-- Input Jawaban -->
                                    <input type="text" name="capthca" placeholder="Jawab disini" required
                                        class="flex-1 bg-white/10 rounded-md px-4 py-2 text-gray-500 placeholder-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-300" />
